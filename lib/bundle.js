	  ...
	  _createClass(Ball, [{
	    ...
	    value: function calculateMovements() {
	      ...
	      if (this.moving === false && !this.paused) {
	        if (this.rightPressed && !(this.xStart + this.radius + 4 > this.canvas.width - 32)) {
	          this.xStart += 4;
	        } else if (this.leftPressed && !(this.xStart - 4 < 32)) {
	          this.xStart -= 4;
	        }
	      }
	    }
	    ...
	    value: function draw() {
	      ...
	      // this.ctx.fillStyle = "#FDDD9B";
	      // this.ctx.fillStyle = "#F4D691";
	    ...
	    value: function wallsRedirect() {
	      ...
	      } else if (this.yStart + this.vertDir - this.radius > this.canvas.height) {
	...
	var Paddle = function () {
	  ...
	  _createClass(Paddle, [{
	    ...
	    value: function drawGradient() {
	      ...
	      // gradient.addColorStop(.125,'blue');
	      // gradient.addColorStop(.25,'orange');
	      // gradient.addColorStop(.375,'blue');
	      // gradient.addColorStop(.5,'orange');
	      // gradient.addColorStop(.625,'blue');
	      // gradient.addColorStop(.75,'orange');
	      // gradient.addColorStop(.875,'blue');
...
/***/ function(module, exports) {
	...
	var LevelDetails = {
	  1: {
	    image: "http://res.cloudinary.com/dg2yejdpt/image/upload/v1470597072/gl_5669b811-0c7c-4232-88c2-7f1c0a771fd0_t9jda7.jpg",
	    name: "National Mall, Washington, DC"
	  },
	  2: {
	    image: "http://res.cloudinary.com/dg2yejdpt/image/upload/v1470597072/gl_5669b817-ba0c-4937-a545-723f0a771fd0_xdo8gn.jpg",
	    name: "Grand Canyon National Park"
	  },
	  3: {
	    image: "http://res.cloudinary.com/dg2yejdpt/image/upload/v1470597072/yellowstone.jpg",
	    name: "Yellowstone National Park"
	  },
	  4: {
	    image: "http://res.cloudinary.com/dg2yejdpt/image/upload/v1470605787/Serengeti.jpg",
	    name: "Serengeti National Park, Tanzania"
	  },
	  5: {
	    image: "http://res.cloudinary.com/dg2yejdpt/image/upload/v1470605849/coney_island.jpg",
	    name: "Coney Island Boardwalk, NYC"
	  },
	  6: {
	    image: "http://res.cloudinary.com/dg2yejdpt/image/upload/v1470597072/yosemite.jpg",
